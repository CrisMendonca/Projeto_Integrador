                ...
                stage('Test image') {
                    steps {
                        script {
                            ...
                            docker.image("grupolovelace:latest").withRun('-p 3000:3000') { c ->
                                sh 'docker ps'
                                sh 'sleep 10'
            ...
            steps { 
                script {
                    if(env.GIT_BRANCH=='origin/homologacao'){
                        ...
                        //sh "docker run -d --name app1 -p 3000:3000 185721683284.dkr.ecr.us-east-1.amazonaws.com/grupolovelace:latest"
